...
var pa = preload("res://cenas/fases/fase_5/pa.tscn").instance()
var pre = preload("res://cenas/fases/fase_5/pre.tscn").instance()
var fu = preload("res://cenas/fases/fase_5/fu.tscn").instance()
