...
var pa = preload("res://cenas/fases/fase_6/pa.tscn").instance()
var pre = preload("res://cenas/fases/fase_6/pre.tscn").instance()
var fu = preload("res://cenas/fases/fase_6/fu.tscn").instance()
...
func _physics_process(_delta):
	if tempo == 0:
		$pplaca_area.visible = false
		$pplaca_area/pplaca_collision.disabled = true
		$pplaca_area2.visible = false
		$pplaca_area2/pplaca_collision.disabled = true	
		...
		$pplaca_area.visible = true
		$pplaca_area/pplaca_collision.disabled = false
		$pplaca_area2.visible = true
		$pplaca_area2/pplaca_collision.disabled = false
